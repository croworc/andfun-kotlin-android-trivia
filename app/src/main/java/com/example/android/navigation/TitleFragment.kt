...
class TitleFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // COMPLETED (10) Call binding.playButton.setOnClickListener and navigate to the gameFragment
    ...
    // COMPLETED (07) Add the Title Fragment to the Navigation Graph
    ...
    // COMPLETED (09) Connect the Title and Game Fragments with an Action
